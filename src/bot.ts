...
import { MessageHandler, AssetHandler, CallHandler, EventHandler, ModHandler } from './Handlers'
;(async () => {
    ...
    const { handleEvents, sendMessageOnJoiningGroup } = new EventHandler(client, messageHandler)
