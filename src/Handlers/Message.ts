...
try {
    ...
    //    if (banned) return void M.reply(`You are banned from using commands`)
        ...
        if (!command) return void M.reply('BAKA!!, The bot will only listen to commands specified in the command list type if you dont want to be blocked Then Type :help to know more.')
