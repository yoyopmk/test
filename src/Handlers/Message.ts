...
try {
    ...
    //    if (banned) return void M.reply(`You are banned from using commands`)
        ...
        if (!command) return void M.reply('BAKA!!, The bot will only listen to commands specified in the command list type ${this.client.config.prefix}help if you dont want to be blocked.')
